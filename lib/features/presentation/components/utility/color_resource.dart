...
class ColorResources {
  ...
  static Color getPrimaryTextColor() {
    return Get.isDarkMode ? const Color(0xFF8dbac3) : const Color(0xFF7383A3);
  }
  ...
  static Color getLightGray() {
    return Get.isDarkMode ? const Color(0xdbdbdb) : const Color(0xFFF3F3F3);
  }
  ...
  static Color containerShedow = const Color(0xFFF2F2F6);
